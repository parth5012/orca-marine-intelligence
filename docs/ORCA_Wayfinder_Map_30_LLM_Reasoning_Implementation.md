...
- [**#31 M-A: Implement Gemini 2.5 Flash Structured Planner Service**](https://github.com/parth5012/orca-marine-intelligence/issues/31) (`wayfinder:task`)
...
- [**#32 M-A: Wire LLM Supervisor & Node-Level Passthrough into LangGraph StateGraph**](https://github.com/parth5012/orca-marine-intelligence/issues/32) (`wayfinder:task`)
...
- [**#33 M-A: Implement Masked LLM Advisory Synthesizer in Decision Agent**](https://github.com/parth5012/orca-marine-intelligence/issues/33) (`wayfinder:task`)
...
- [**#34 M-A: Connect Real-Time Native SSE Token Streaming via `on_chat_model_stream`**](https://github.com/parth5012/orca-marine-intelligence/issues/34) (`wayfinder:task`)
...
- [**#35 M-A: Decommission Legacy Regex Fallbacks in Orchestrator & Helpers**](https://github.com/parth5012/orca-marine-intelligence/issues/35) (`wayfinder:task`)
...
- [**#36 M-A: Dynamic Reasoning Verification Suite & Latency Benchmark**](https://github.com/parth5012/orca-marine-intelligence/issues/36) (`wayfinder:task`)
